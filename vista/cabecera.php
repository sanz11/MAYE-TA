...
<header>
		<div class="contenedor">
			...
			<label class="icon-menu1" for="menu-bar">[]</label>
				...
				<div class="perfil">
				    <div class="datos">
				        <?php echo '<img src="'.$_SESSION['fotoadmin'].'">';?>
				        <div class="gmail">
				        <div class="section">
				        <br>
				        <h1><?php echo $_SESSION['nombreadmin']." ".$_SESSION['apellidosadmin'];?></h1>
				        <h3><?php echo $_SESSION['correoadmin'];?></h3>
...
<div class="modal fade veterinaria" id="miventana" tabindex="-1"role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  	<div class="modal-dialog">
          ...
          <center> <label for="check"><span class="edit glyphicon glyphicon-cog" > Editar_datos </span></label>
            ...
            <a href="index.php?cerrar=session"  title="Editar Perfil">
                <span class="glyphicon glyphicon-log-out"title="Cerrar Session"> Cerrar_Sesión</span>
            </a> 
            </center> 
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" value="<?php echo $_SESSION['correoadmin'];?>" name="email" >
  </div>
  <div class="form-group">
    <label for="telefono">Teléfono:</label>
    <input type="text" class="form-control" value="<?php echo $_SESSION["telefonoadmin"];?>" name="telefono">
  </div>
  <div class="form-group">
  ...
  <input style="display:none;"type="text" value="<?php echo $_SESSION['fotoadmin'];?>" name="fotoactu">
  <center>
