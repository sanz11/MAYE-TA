       ...
       <tr class="info">
        ...
        <?php
          ...
          foreach($matrizAdmin as $registro){
           ...
           <td><button class='btn btn-danger btn-xs'><span class='glyphicon glyphicon-trash'></span></button><button class='btn btn-success btn-xs'><span class='glyphicon glyphicon-pencil'></span></button> </td>
           </tr>";
            }}
          else{
